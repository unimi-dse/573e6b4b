#' Dataset made only by numeric features describing crime in USA and its dependencies by some variables such as key socioeconomic
...
#'
#'
#'#' @format A data frame with 51 rows and 11 variables:
#' \describe{
...
#'   ...
#' }
#' @source \url{https://github.com/fivethirtyeight/data/tree/master/hate-crimes}
"trumpn"
